        ...
        <div class="header">
            <div class="header-left active">
                <a href="index.html" class="logo">
                    <img src="{{ asset('Template/img/Hilya.jpeg') }}" alt="">
                </a>
            ...
            <ul class="nav user-menu">
                <li class="nav-item dropdown has-arrow main-drop">
                    <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                        <span class="user-img"><img src="{{ asset('Template/img/HilyatulAulia.jpeg') }}" alt="">
            ...
            <div class="dropdown mobile-user-menu">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('logout-form-mobile').submit();">Logout
                    </a>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="{{ strpos(Route::currentRouteName(), 'mahasiswa') !== false ? 'nav-item active' : 'nav-item' }}">
                            <a href="{{ route('mahasiswa.index') }}"><i data-feather="user"></i><span> Mahasiswa</span></a>
                        </li>
                        <li class="{{ strpos(Route::currentRouteName(), 'dosen') !== false ? 'nav-item active' : 'nav-item' }}">
                            <a href="{{ route('dosen.index') }}"><i data-feather="user"></i><span> dosen</span></a>
                        </li>
                        <li class="{{ strpos(Route::currentRouteName(), 'matakuliah') !== false ? 'nav-item active' : 'nav-item' }}">
                            <a href="{{ route('matakuliah.index') }}"><i data-feather="user"></i><span> Matakuliah</span></a>
                        </li>
